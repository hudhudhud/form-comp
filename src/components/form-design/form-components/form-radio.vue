        ...
        <div class="cell-value">
            <div :class="{row:direction=='row',column:direction=='column'}">
                <label class="cell-radio-label" v-for='(it,i) of list' :key='i'>
                    <input type="radio" v-bind="$attrs" v-on="listeners" :checked='status==it[valueKey]' @change='status=it[valueKey]'
                    class="mint-radio-input" :disabled='onlyShowIn||item.readonly'> 
